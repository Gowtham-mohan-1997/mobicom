Feature: Mobicom Automation Testcasess
    ...
    @Alltag @contractReviewModification
    ...
    @Alltag @ContractDraft-authorization 
    ...
    And Contract Documents Verification task
     ...
     And complete the contract termination
      ...
      @Alltag @renewecontractReviewModification
    ...
    And  complete the resubmission task in initiator
     ...
     @Alltag @renewalContractDraft-Reviewal 
    ...
    @Alltag @renewalContractDraft-authorization 
    ...
    @Alltag @renewecontractReviewReject
    ...
    @Alltag @renewalContractDraft-ReviewalReject 
    ...
    @Alltag @renewalContractDraft-authorizationReject 
    ...
    @Alltag @oldcontractrenewecontractReviewModification
   ...
   @Alltag @oldcontractreneweContractDraft-Reviewal 
    Scenario: complete the ContractDraft-Reviewal with send for modification
    ...
    @Alltag @oldcontractreneweContractDraft-authorization 
    ...
    And  complete the resubmission_task
     ...
     @Alltag @oldcontractrenewecontractReviewReject
    Scenario: complete the contractreviewaltask with Reject
   ...
   # When complete the contract reviewal task_one with Rejected
    Then complete contract reviewal task two with the Reject
     ...
     @Alltag @oldcontractreneweContractDraft-ReviewalReject 
    Scenario: complete the ContractDraft-Reviewal with Reject
    ...
    @Alltag @oldcontractreneweContractDraft-authorizationReject 
    Scenario: complete the ContractDraft-authorization with Reject
