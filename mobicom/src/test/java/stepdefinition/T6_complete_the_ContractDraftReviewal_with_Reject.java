...
public class T6_complete_the_ContractDraftReviewal_with_Reject extends common_fucntion{
	public static String select;
	public String receiptValue1 =new Timestamp(System.currentTimeMillis()).toString();

	@Given("Create the new contract Request")
	public void Create_the_new_contract_Request() throws IOException, InterruptedException {
