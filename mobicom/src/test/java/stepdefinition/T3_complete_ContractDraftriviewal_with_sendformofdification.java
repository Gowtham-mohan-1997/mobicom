...
public class T3_complete_ContractDraftriviewal_with_sendformofdification extends common_fucntion{
	public static String select;
	public String receiptValue1 =new Timestamp(System.currentTimeMillis()).toString();

	@Given("create the contract_requests")
	public void create_the_contract_requests() throws IOException, InterruptedException {
