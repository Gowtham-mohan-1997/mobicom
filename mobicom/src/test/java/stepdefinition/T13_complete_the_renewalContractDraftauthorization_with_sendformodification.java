...
public class T13_complete_the_renewalContractDraftauthorization_with_sendformodification extends common_fucntion{
	...
	@Then("complete the Contract Draft authorization task with send for modification")
