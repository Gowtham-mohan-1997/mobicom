...
public class T5_complete_the_contractreviewaltask_with_Reject extends common_fucntion{
	public static String select;
	public String receiptValue1 =new Timestamp(System.currentTimeMillis()).toString();

	@Given("create the ContractRequest")
	public void create_the_ContractRequest() throws IOException, InterruptedException {
		launchbrowser();
		Thread.sleep(1000);
	...
	public void complete_the_contract_reviewal_task_one_with_Reject() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void complete_the_contract_reviewal_task_two_with_Reject() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
