...
public class T8_complete_renew_contract_request extends common_fucntion{
	...
	public void complete_the_contract_draft_reviewal_task1_with_approve() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Complete_ontract_drafted_reviewal_task2_with_approve() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void complete_the_Contract_Lawyer_Allocation_task_for_select_layer() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void complete_Contract_DraftedLawyer_approval_Task() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void complete_Contract_Drafted_Authorization_task_with_approve() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Upload_updated_Brief_Information_Document_task() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Upload_Signed_Contract_task() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Contract_Documents_Verification_task() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
