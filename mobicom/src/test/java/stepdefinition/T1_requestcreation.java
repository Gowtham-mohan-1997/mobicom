...
public class T1_requestcreation extends common_fucntion {
	...
	public void i_launch_the_browser_and_open_the_application() throws IOException {
		launchbrowser();
	}

	@When("I log in as an initiator")
	public void i_log_in_as_an_initiator() throws InterruptedException {
	...
	public void Contract_Draft_Reviewal_task_completed_with_approve() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Contract_Draft_Reviewal_task1_completed_with_approve() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void completetheContractLawyerAllocationtask() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void completetheContractDraftLawyerApprovaltask() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void completetheContractDraftAuthorizationtask() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void completetheUploadupdatedBriefInformationDocumenttask() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void completetheUploadSignedContracttask() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void completetheContractDocumentsVerificationtask() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
