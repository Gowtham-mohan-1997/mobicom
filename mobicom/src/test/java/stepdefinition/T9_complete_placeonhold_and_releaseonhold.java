...
public class T9_complete_placeonhold_and_releaseonhold extends common_fucntion{
	public static String select;
	public String receiptValue1 =new Timestamp(System.currentTimeMillis()).toString();

	@Given("create new request with yes")
	public void create_new_request_with_yes() throws IOException, InterruptedException {
		launchbrowser();
		Thread.sleep(1000);
	...
	public void contract_draft_reviewal_first_task_should_be_complete() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void contract_draft_reviewal_second_task_should_be_complete() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Contract_Lawyer_Allocation_task_should_be_complete() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Contract_Draft_Lawyer_Approval_task_should_complete_with_approve() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Contract_Draft_Authorization_task_should_be_complete_with_approve() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Upload_updated_Brief_Information_Document_task_should_be_complete() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Upload_Signed_Contract_task_should_be_complete() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void Contract_Documents_Verification_task_should_be_complete() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
	...
	public void create_the_renew_contract_request() throws InterruptedException {
		...
		while (s.equals(true)) {
			...
			(select1.contains(select)) {
				...
				s = false;
				Thread.sleep(1000);
				page_fucntion.placeonhold.click();
				Thread.sleep(1000);
				page_fucntion.freezeenddate.click();
				Thread.sleep(1000);
				page_fucntion.today.click();
				Thread.sleep(1000);
			page_fucntion.reasonforfreeze.sendKeys("placeonhold");
			Thread.sleep(1000);
	...
	public void complete_the_releasehold() throws InterruptedException {
		PageFactory.initElements(driver, login_page.class);
		...
		while (s.equals(true)) {
			...
			(select1.contains(select)) {
				...
				s = false;
				Thread.sleep(1000);
				page_fucntion.releasehold.click();
				Thread.sleep(1000);
				page_fucntion.useremarks.sendKeys("releaseonhold");;
				Thread.sleep(1000);
				page_fucntion.save.click();
				Thread.sleep(1000);
				page_fucntion.contractlist.click();
